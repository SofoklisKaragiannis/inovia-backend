...
public class RemoveProductController {
    ...
    @ApiOperation(value = "Operation to remove a product by id")
    public DeferredResult<ResponseEntity<ProductModel>> removeProduct(@RequestParam Map<String, String> parameters,
        ...
        if (!product.equals(Optional.empty())) {
           ...
           productModel = StaticContent.productEntityToModel(product.get());
            ...
            statusMessage.setMessage("Wrong product id!");
